...
class CALC_Misc_panther(CALC_Misc_nixi):
    ...
    def calc_misc_Panther(self, model):
        ...
        self._reg_write(model.vars.MODEM_EN_EN, 0)
        ...
        self._reg_write(model.vars.MODEM_DIGMIXCTRL_MIXERCONJ, 0)
        ...
        self._reg_write(model.vars.MODEM_IEN_TXFRAMESENT, 0)
        self._reg_write(model.vars.MODEM_IEN_TXSYNCSENT, 0)
        self._reg_write(model.vars.MODEM_IEN_TXPRESENT, 0)
        self._reg_write(model.vars.MODEM_IEN_RXTIMDET, 0)
        self._reg_write(model.vars.MODEM_IEN_RXPREDET, 0)
        self._reg_write(model.vars.MODEM_IEN_RXFRAMEDET0, 0)
        self._reg_write(model.vars.MODEM_IEN_RXFRAMEDET1, 0)
        self._reg_write(model.vars.MODEM_IEN_RXTIMLOST, 0)
        self._reg_write(model.vars.MODEM_IEN_RXPRELOST, 0)
        self._reg_write(model.vars.MODEM_IEN_RXFRAMEDETOF, 0)
        self._reg_write(model.vars.MODEM_IEN_RXTIMNF, 0)
        self._reg_write(model.vars.MODEM_IEN_FRCTIMOUT, 0)
