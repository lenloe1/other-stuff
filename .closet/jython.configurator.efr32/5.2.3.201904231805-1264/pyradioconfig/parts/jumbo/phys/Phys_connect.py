...
class PHYS_connect(IPhy):
    ...
    def PHY_Connect_915MHz_2GFSK_500kbps(self, model):
    ...
    def PHY_Connect_902MHz_2GFSK_200kbps(self, model):
    ...
    def PHY_Connect_434MHz_2GFSK_200kbps(self, model):
    ...
    def PHY_Connect_863MHz_2GFSK_100kbps(self, model):
    ...
    def PHY_Connect_169MHz_2GFSK_4p8kbps(self, model):
    ...
    def PHY_Connect_490MHz_2GFSK_10kbps(self, model):
    ...
    def PHY_Connect_920MHz_2GFSK_100kbps(self, model):
    ...
    def PHY_Connect_424MHz_2GFSK_4p8kbps(self, model):
    ...
    def PHY_Connect_447MHz_2GFSK_4p8kbps(self, model):
    ...
    def PHY_Connect_917MHz_2GFSK_4p8kbps(self, model):
    ...
    def PHY_Connect_915MHz_OQPSK_500kbps(self, model):
        phy = self._makePhy(model, model.profiles.Connect, 'DSSS 500', readable_name="Connect 915MHz OQPSK 500Kbps")
    ...
    def PHY_Connect_915mhz_oqpsk_800kcps_100kbps(self, model):
    ...
    def debug_PHY_Connect_IEEE802154_2p4GHz_coh(self, model):
        phy = self._makePhy(model, model.profiles.Base, 'test phy for porting coh demod from ieee to connect')
    ...
    def PHY_Connect_915mhz_oqpsk_2Mcps_250kbps(self, model):
