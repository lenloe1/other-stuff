...
class CALC_Misc_nixi(CALC_Misc_jumbo):
    ...
    def calc_misc(self, model):
        ...
        # FIXME: this is not the best way to acheive this. For Panther and Lynx, this value is calculated--it cannot be touched here. Panther and Lynx inherit this.
        if model.part_family.lower() in ["nixi"]:
        ...
        # Nixi & Panther-specific. Not in Lynx.
