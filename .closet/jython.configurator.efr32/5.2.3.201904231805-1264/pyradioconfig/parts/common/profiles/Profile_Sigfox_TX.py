...
class Profile_Sigfox_TX(IProfile):
    ...
    def buildProfileModel(self, model):
        ...
        #IProfile.make_required_input(profile, model.vars.syncword_0,             "syncword", readable_name="Sync Word 0",                value_limit_min= long(0),        value_limit_max=0xffffffffL)
        #IProfile.make_required_input(profile, model.vars.syncword_1,             "syncword", readable_name="Sync Word 1",                value_limit_min= long(0),        value_limit_max=0xffffffffL)
        ...
        #IProfile.make_required_input(profile, model.vars.asynchronous_rx_enable, "modem",          input_type=ModelInputType.OPTIONAL, default=False, readable_name="Enable Asynchronous direct mode")
        ...
        #IProfile.make_required_input(profile, model.vars.symbol_encoding,        "symbol_coding",  readable_name="Symbol Encoding", default=model.vars.symbol_encoding.var_enum.NRZ)
        #IProfile.make_required_input(profile, model.vars.manchester_mapping,     "symbol_coding",  readable_name="Manchester Code Mapping", default=model.vars.manchester_mapping.var_enum.Default)
        #IProfile.make_required_input(profile, model.vars.dsss_chipping_code,     "symbol_coding",  readable_name="DSSS Chipping Code Base",    value_limit_min= long(0),        value_limit_max=0xffffffffL)
        ...
        IProfile.make_optional_input(profile, model.vars.test_ber,               "testing",        default=False, readable_name="Reconfigure for BER testing")
        ...
        profile.inputs.frame_type_bits.default = 0
    ...
    def profile_calculate(self, model):
        ...
        model.vars.sqi_threshold.value_forced = 0
