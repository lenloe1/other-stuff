...
def buildCrcOutputs(model, profile, family):
    ...
    if family in ["panther", "lynx", "ocelot"]:
...
def buildFrameInputs(model, profile, family):
    ...
    if family == 'nerio' or family == 'nixi' or family =='panther' or family=='lynx':           # TODO Is this correct?  Do we include this in Nixi?
    ...
    # -- Variable Length --
    IProfile.make_optional_input(profile, model.vars.var_length_numbits, 'frame_var_length', default=0, readable_name="Variable Length Bit Size", value_limit_min=0, value_limit_max=12)
    ...
    IProfile.make_optional_input(profile, model.vars.var_length_maxlength, 'frame_var_length', default=0, readable_name="Maximum Length", value_limit_min=0, value_limit_max=4095)
    ...
    IProfile.make_optional_input(profile, model.vars.frame_type_bits, 'frame_type_length', default=0, readable_name="Number of Frame Type Bits", value_limit_min=0, value_limit_max=3)
    ...
    IProfile.make_optional_input(profile, model.vars.frame_type_0_length, 'frame_type_length', default=0, readable_name="Frame Type 0 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_1_length, 'frame_type_length', default=0, readable_name="Frame Type 1 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_2_length, 'frame_type_length', default=0, readable_name="Frame Type 2 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_3_length, 'frame_type_length', default=0, readable_name="Frame Type 3 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_4_length, 'frame_type_length', default=0, readable_name="Frame Type 4 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_5_length, 'frame_type_length', default=0, readable_name="Frame Type 5 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_6_length, 'frame_type_length', default=0, readable_name="Frame Type 6 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_7_length, 'frame_type_length', default=0, readable_name="Frame Type 7 Length", value_limit_min=0, value_limit_max=MAX_FRAME_TYPE_LENGTH)
    IProfile.make_optional_input(profile, model.vars.frame_type_0_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 0")
    IProfile.make_optional_input(profile, model.vars.frame_type_1_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 1")
    IProfile.make_optional_input(profile, model.vars.frame_type_2_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 2")
    IProfile.make_optional_input(profile, model.vars.frame_type_3_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 3")
    IProfile.make_optional_input(profile, model.vars.frame_type_4_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 4")
    IProfile.make_optional_input(profile, model.vars.frame_type_5_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 5")
    IProfile.make_optional_input(profile, model.vars.frame_type_6_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 6")
    IProfile.make_optional_input(profile, model.vars.frame_type_7_valid, 'frame_type_length', default=False, readable_name="Accept Frame Type 7")
    IProfile.make_optional_input(profile, model.vars.frame_type_0_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 0")
    IProfile.make_optional_input(profile, model.vars.frame_type_1_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 1")
    IProfile.make_optional_input(profile, model.vars.frame_type_2_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 2")
    IProfile.make_optional_input(profile, model.vars.frame_type_3_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 3")
    IProfile.make_optional_input(profile, model.vars.frame_type_4_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 4")
    IProfile.make_optional_input(profile, model.vars.frame_type_5_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 5")
    IProfile.make_optional_input(profile, model.vars.frame_type_6_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 6")
    IProfile.make_optional_input(profile, model.vars.frame_type_7_filter, 'frame_type_length', default=True, readable_name="Apply Address Filter for Frame Type 7")
...
def buildFrameOutputs(model, profile, family):
    ...
    if family in ["dumbo", "jumbo", "nerio", "nixi"]:
        ...
        if family in ["nerio", "panther", "lynx"]:
