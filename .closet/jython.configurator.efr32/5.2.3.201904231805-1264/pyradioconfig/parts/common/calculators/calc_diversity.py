...
class CALC_Diversity(ICalculator):
    ...
    def buildVariables(self, model):
        ...
        member_data = [
            ...
            ['ANTSELCORR'   , 3, 'Select-Best algorithm based on correlation value'],
    ...
    def calc_diversity_values(self, model):
        ...
        if model.part_family.lower() in ["jumbo", "nerio", "nixi", "panther", "lynx"]:
    ...
    def calc_diversity_div_demod_reset_period_hemi_usec_value(self, model):
        ...
        if model.part_family.lower() in ["jumbo", "nerio", "nixi"]:
            ...
            elif (antdivmode == model.vars.antdivmode.var_enum.ANTSELFIRST) or (antdivmode == model.vars.antdivmode.var_enum.ANTSELCORR) or (antdivmode == model.vars.antdivmode.var_enum.ANTSELRSSI):
    ...
    def calc_diversity_div_demod_reset_period_hemi_usec_reg(self, model):
        ...
        if model.part_family.lower() in ["jumbo", "nerio", "nixi"]:
            ...
            if (antdivmode == model.vars.antdivmode.var_enum.ANTSELFIRST) or (antdivmode == model.vars.antdivmode.var_enum.ANTSELCORR) or (antdivmode == model.vars.antdivmode.var_enum.ANTSELRSSI):
