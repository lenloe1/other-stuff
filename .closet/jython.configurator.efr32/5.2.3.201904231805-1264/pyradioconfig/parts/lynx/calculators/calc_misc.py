...
class CALC_Misc_lynx(CALC_Misc_panther):
    ...
    def calc_misc_Lynx(self, model):
        ...
        self._reg_write(model.vars.AGC_CTRL4_PERIODRFPKD, 14)
        self._reg_write(model.vars.AGC_CTRL4_RFPKDPRDGEAR, 0)
        self._reg_write(model.vars.AGC_CTRL4_RFPKDSYNCSEL, 0)
        self._reg_write(model.vars.AGC_CTRL4_RFPKDSEL, 0)
        self._reg_write(model.vars.AGC_CTRL4_FRZPKDEN, 0)
        self._reg_write(model.vars.AGC_CTRL4_RFPKDCNTEN, 0)
        self._reg_write(model.vars.AGC_CTRL5_PNUPDISTHD, 0)
        self._reg_write(model.vars.AGC_CTRL5_PNUPRELTHD, 0)
        self._reg_write(model.vars.AGC_CTRL6_SEQPNUPALLOW, 0)
        self._reg_write(model.vars.AGC_CTRL6_SEQRFPKDEN, 0)
        self._reg_write(model.vars.AGC_GAINSTEPLIM_PNINDEXMAX, 17)
        self._reg_write(model.vars.AGC_PNRFATT3_LNAMIXRFATT15, 127)
        self._reg_write(model.vars.AGC_PNRFATT3_LNAMIXRFATT16, 246)
        self._reg_write(model.vars.AGC_PNRFATT3_LNAMIXRFATT17, 500)
        ...
        self._reg_write(model.vars.FRC_PKTBUFCTRL_PKTBUFSTARTLOC, 0)
        self._reg_write(model.vars.FRC_PKTBUFCTRL_PKTBUFTHRESHOLD, 0)
        self._reg_write(model.vars.FRC_PKTBUFCTRL_PKTBUFTHRESHOLDEN, 0)
        ...
        self._reg_write(model.vars.MODEM_RAMPCTRL_RAMPRATE0, 5)
        self._reg_write(model.vars.MODEM_RAMPCTRL_RAMPRATE1, 5)
        self._reg_write(model.vars.MODEM_RAMPCTRL_RAMPRATE2, 5)
        ...
        self._reg_write(model.vars.RAC_LNAMIXTRIM0_LNAMIXRFPKDCALCM, 32)
        ...
        self._reg_write(model.vars.RAC_LNAMIXTRIM1_LNAMIXIBIASADJ, 8)
        ...
        self._reg_write(model.vars.RAC_LNAMIXCAL_LNAMIXENIRCAL, 0)
        self._reg_write(model.vars.RAC_LNAMIXCAL_LNAMIXIRCALAMP, 7)
