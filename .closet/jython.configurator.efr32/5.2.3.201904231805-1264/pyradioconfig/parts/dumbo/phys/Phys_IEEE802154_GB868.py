...
class PHYS_IEEE802154_GB868(IPhy):
    ...
    def IEEE802154_GB868_154G_PHR(self, phy, model):
        ...
        phy.profile_inputs.var_length_minlength.value  = 5    # NOT 15.4g's 4
    ...
    def PHY_IEEE802154_GB868_863MHz_PHR2(self, model):
        phy = self._makePhy(model, model.profiles.Base, 'PHY_IEEE802154_GB868_863MHz_PHR2')
    ...
    def PHY_IEEE802154_GB868_915MHz_PHR2(self, model):
        phy = self._makePhy(model, model.profiles.Base, 'PHY_IEEE802154_GB868_915MHz_PHR2')
        self.IEEE802154_GB868_Base(phy, model)
        self.IEEE802154_GB868_154G_PHR(phy, model)
