...
class IPhy(object):
    ...
    """
    @abstractmethod
    def _makePhy(self, modem_model, profile, phy_description=None, phy_group_name=None, readable_name=None, act_logic='', tags=''):
        ...
        if tags is None:
            tags = ""
        phy = ModelPhy(phy_function_name, phy_description, profile, phy_group_name, readable_name=readable_name, act_logic=act_logic, tags=tags)
