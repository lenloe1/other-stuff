...
class RM_Register_MODEM_DSACTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TIMEST = RM_Field_MODEM_DSACTRL_TIMEST(self)
        self.zz_fdict['TIMEST'] = self.TIMEST
        self.AGCDEBOUNDLY = RM_Field_MODEM_DSACTRL_AGCDEBOUNDLY(self)
        self.zz_fdict['AGCDEBOUNDLY'] = self.AGCDEBOUNDLY
