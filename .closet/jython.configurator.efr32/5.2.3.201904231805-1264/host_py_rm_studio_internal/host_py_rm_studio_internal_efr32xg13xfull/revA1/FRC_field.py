...
class RM_Field_FRC_MIRRORIF_TXDONEM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXDONEM, self).__init__(register,
            'TXDONEM', 'FRC.MIRRORIF.TXDONEM', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXAFTERFRAMEDONEM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXAFTERFRAMEDONEM, self).__init__(register,
            'TXAFTERFRAMEDONEM', 'FRC.MIRRORIF.TXAFTERFRAMEDONEM', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXABORTEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXABORTEDM, self).__init__(register,
            'TXABORTEDM', 'FRC.MIRRORIF.TXABORTEDM', 'read-only',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXUFM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXUFM, self).__init__(register,
            'TXUFM', 'FRC.MIRRORIF.TXUFM', 'read-only',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_RXDONEM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_RXDONEM, self).__init__(register,
            'RXDONEM', 'FRC.MIRRORIF.RXDONEM', 'read-only',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_RXABORTEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_RXABORTEDM, self).__init__(register,
            'RXABORTEDM', 'FRC.MIRRORIF.RXABORTEDM', 'read-only',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_FRAMEERRORM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_FRAMEERRORM, self).__init__(register,
            'FRAMEERRORM', 'FRC.MIRRORIF.FRAMEERRORM', 'read-only',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_BLOCKERRORM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_BLOCKERRORM, self).__init__(register,
            'BLOCKERRORM', 'FRC.MIRRORIF.BLOCKERRORM', 'read-only',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_RXOFM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_RXOFM, self).__init__(register,
            'RXOFM', 'FRC.MIRRORIF.RXOFM', 'read-only',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_ADDRERRORM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_ADDRERRORM, self).__init__(register,
            'ADDRERRORM', 'FRC.MIRRORIF.ADDRERRORM', 'read-only',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_BUSERRORM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_BUSERRORM, self).__init__(register,
            'BUSERRORM', 'FRC.MIRRORIF.BUSERRORM', 'read-only',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_SNIFFOFM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_SNIFFOFM, self).__init__(register,
            'SNIFFOFM', 'FRC.MIRRORIF.SNIFFOFM', 'read-only',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_FRAMEDETPAUSEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_FRAMEDETPAUSEDM, self).__init__(register,
            'FRAMEDETPAUSEDM', 'FRC.MIRRORIF.FRAMEDETPAUSEDM', 'read-only',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_INTERLEAVEWRITEPAUSEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_INTERLEAVEWRITEPAUSEDM, self).__init__(register,
            'INTERLEAVEWRITEPAUSEDM', 'FRC.MIRRORIF.INTERLEAVEWRITEPAUSEDM', 'read-only',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_INTERLEAVEREADPAUSEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_INTERLEAVEREADPAUSEDM, self).__init__(register,
            'INTERLEAVEREADPAUSEDM', 'FRC.MIRRORIF.INTERLEAVEREADPAUSEDM', 'read-only',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXSUBFRAMEPAUSEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXSUBFRAMEPAUSEDM, self).__init__(register,
            'TXSUBFRAMEPAUSEDM', 'FRC.MIRRORIF.TXSUBFRAMEPAUSEDM', 'read-only',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_CONVPAUSEDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_CONVPAUSEDM, self).__init__(register,
            'CONVPAUSEDM', 'FRC.MIRRORIF.CONVPAUSEDM', 'read-only',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True
