...
class RM_Field_MODEM_CTRL5_XINGDEBUG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_CTRL5_XINGDEBUG, self).__init__(register,
            'XINGDEBUG', 'MODEM.CTRL5.XINGDEBUG', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_LONGRANGE_LRCORRTHDDYNEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_LONGRANGE_LRCORRTHDDYNEN, self).__init__(register,
            'LRCORRTHDDYNEN', 'MODEM.LONGRANGE.LRCORRTHDDYNEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_PADEBUG_MANPAAMPCTRL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_PADEBUG_MANPAAMPCTRL, self).__init__(register,
            'MANPAAMPCTRL', 'MODEM.PADEBUG.MANPAAMPCTRL', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_PADEBUG_ENMANPAAMPCTRL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_PADEBUG_ENMANPAAMPCTRL, self).__init__(register,
            'ENMANPAAMPCTRL', 'MODEM.PADEBUG.ENMANPAAMPCTRL', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_PADEBUG_ENMANPATRIMPASLICE0DBM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_PADEBUG_ENMANPATRIMPASLICE0DBM, self).__init__(register,
            'ENMANPATRIMPASLICE0DBM', 'MODEM.PADEBUG.ENMANPATRIMPASLICE0DBM', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True
