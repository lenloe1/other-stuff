...
class RM_Field_FRC_MIRRORIF_TXDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXDONE, self).__init__(register,
            'TXDONE', 'FRC.MIRRORIF.TXDONE', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXAFTERFRAMEDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXAFTERFRAMEDONE, self).__init__(register,
            'TXAFTERFRAMEDONE', 'FRC.MIRRORIF.TXAFTERFRAMEDONE', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXABORTED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXABORTED, self).__init__(register,
            'TXABORTED', 'FRC.MIRRORIF.TXABORTED', 'read-only',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXUF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXUF, self).__init__(register,
            'TXUF', 'FRC.MIRRORIF.TXUF', 'read-only',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_RXDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_RXDONE, self).__init__(register,
            'RXDONE', 'FRC.MIRRORIF.RXDONE', 'read-only',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_RXABORTED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_RXABORTED, self).__init__(register,
            'RXABORTED', 'FRC.MIRRORIF.RXABORTED', 'read-only',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_FRAMEERROR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_FRAMEERROR, self).__init__(register,
            'FRAMEERROR', 'FRC.MIRRORIF.FRAMEERROR', 'read-only',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_BLOCKERROR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_BLOCKERROR, self).__init__(register,
            'BLOCKERROR', 'FRC.MIRRORIF.BLOCKERROR', 'read-only',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_RXOF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_RXOF, self).__init__(register,
            'RXOF', 'FRC.MIRRORIF.RXOF', 'read-only',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_ADDRERROR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_ADDRERROR, self).__init__(register,
            'ADDRERROR', 'FRC.MIRRORIF.ADDRERROR', 'read-only',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_BUSERROR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_BUSERROR, self).__init__(register,
            'BUSERROR', 'FRC.MIRRORIF.BUSERROR', 'read-only',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_SNIFFOF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_SNIFFOF, self).__init__(register,
            'SNIFFOF', 'FRC.MIRRORIF.SNIFFOF', 'read-only',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_FRAMEDETPAUSED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_FRAMEDETPAUSED, self).__init__(register,
            'FRAMEDETPAUSED', 'FRC.MIRRORIF.FRAMEDETPAUSED', 'read-only',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_INTERLEAVEWRITEPAUSED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_INTERLEAVEWRITEPAUSED, self).__init__(register,
            'INTERLEAVEWRITEPAUSED', 'FRC.MIRRORIF.INTERLEAVEWRITEPAUSED', 'read-only',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_INTERLEAVEREADPAUSED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_INTERLEAVEREADPAUSED, self).__init__(register,
            'INTERLEAVEREADPAUSED', 'FRC.MIRRORIF.INTERLEAVEREADPAUSED', 'read-only',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_TXSUBFRAMEPAUSED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_TXSUBFRAMEPAUSED, self).__init__(register,
            'TXSUBFRAMEPAUSED', 'FRC.MIRRORIF.TXSUBFRAMEPAUSED', 'read-only',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_CONVPAUSED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_CONVPAUSED, self).__init__(register,
            'CONVPAUSED', 'FRC.MIRRORIF.CONVPAUSED', 'read-only',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FRC_MIRRORIF_IFMIRRORCLEAR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_MIRRORIF_IFMIRRORCLEAR, self).__init__(register,
            'IFMIRRORCLEAR', 'FRC.MIRRORIF.IFMIRRORCLEAR', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FRC_RAMBASEADDR_RAMBASEADDR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_RAMBASEADDR_RAMBASEADDR, self).__init__(register,
            'RAMBASEADDR', 'FRC.RAMBASEADDR.RAMBASEADDR', 'read-write',
            u"",
            12, 20)
        self.__dict__['zz_frozen'] = True
