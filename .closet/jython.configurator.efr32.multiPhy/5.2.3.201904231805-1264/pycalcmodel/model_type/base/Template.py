...
#
# Generated Mon Feb 06 18:44:16 2017 by generateDS.py version 2.12d.
#
...
#
# Command line:
#   T:\python_2_7_7_win32_rel_15\Scripts\generateDS.py -o "..\..\model_type\base\Bindings.py" --super="Bindings" -s "..\..\model_type\base\Template.py" --subclass-suffix -m -f --silence .\model_type.xsd
#
...
class model(supermod.model):
    def __init__(self, calc_version=None, part_family=None, xsd_version=None, phys=None, profiles=None, variables=None, features=None):
        super(model, self).__init__(calc_version, part_family, xsd_version, phys, profiles, variables, features, )
...
class inputType1(supermod.inputType1):
    def __init__(self, value_limit_max=None, units_multiplier=None, input_type=None, is_array=None, default_visiblity=None, deprecated=None, value_limit_min=None, fractional_digits=None, readable_name=None, category=None, var_name=None, defaults=None):
        super(inputType1, self).__init__(value_limit_max, units_multiplier, input_type, is_array, default_visiblity, deprecated, value_limit_min, fractional_digits, readable_name, category, var_name, defaults, )
...
class outputType2(supermod.outputType2):
    def __init__(self, output_type=None, is_array=None, value_limit_max=None, value_limit_min=None, fractional_digits=None, readable_name=None, category=None, var_name=None):
        super(outputType2, self).__init__(output_type, is_array, value_limit_max, value_limit_min, fractional_digits, readable_name, category, var_name, )
...
class variableType(supermod.variableType):
    def __init__(self, name=None, format=None, is_array=None, forceable=None, svd_mapping=None, units=None, type_=None, desc=None, enum=None):
        super(variableType, self).__init__(name, format, is_array, forceable, svd_mapping, units, type_, desc, enum, )
