...
class RM_Register_AGC_STATUS2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RFPKTLATCNT = RM_Field_AGC_STATUS2_RFPKTLATCNT(self)
...
class RM_Register_AGC_CTRL6(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SEQPNUPALLOW = RM_Field_AGC_CTRL6_SEQPNUPALLOW(self)
        self.zz_fdict['SEQPNUPALLOW'] = self.SEQPNUPALLOW
        self.SEQRFPKDEN = RM_Field_AGC_CTRL6_SEQRFPKDEN(self)
...
class RM_Register_AGC_GAINSTEPLIM(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PNINDEXMAX = RM_Field_AGC_GAINSTEPLIM_PNINDEXMAX(self)
...
class RM_Register_AGC_PNRFATT3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT15 = RM_Field_AGC_PNRFATT3_LNAMIXRFATT15(self)
        self.zz_fdict['LNAMIXRFATT15'] = self.LNAMIXRFATT15
        self.LNAMIXRFATT16 = RM_Field_AGC_PNRFATT3_LNAMIXRFATT16(self)
        self.zz_fdict['LNAMIXRFATT16'] = self.LNAMIXRFATT16
        self.LNAMIXRFATT17 = RM_Field_AGC_PNRFATT3_LNAMIXRFATT17(self)
