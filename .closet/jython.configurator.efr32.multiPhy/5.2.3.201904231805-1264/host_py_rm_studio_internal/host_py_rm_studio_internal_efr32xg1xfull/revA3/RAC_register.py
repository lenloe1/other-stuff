...
class RM_Register_RAC_SYNTHREGCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_RAC_SYNTHREGCTRL, self).__init__(rmio, label,
            ...
            u"",
            0x03636D80, 0x07FFFFEB)

        self.UNUSED3 = RM_Field_RAC_SYNTHREGCTRL_UNUSED3(self)
        self.zz_fdict['UNUSED3'] = self.UNUSED3
        self.UNUSED1 = RM_Field_RAC_SYNTHREGCTRL_UNUSED1(self)
        self.zz_fdict['UNUSED1'] = self.UNUSED1
        self.UNUSED2 = RM_Field_RAC_SYNTHREGCTRL_UNUSED2(self)
        self.zz_fdict['UNUSED2'] = self.UNUSED2
...
class RM_Register_RAC_VCOCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.UNUSED4 = RM_Field_RAC_VCOCTRL_UNUSED4(self)
        self.zz_fdict['UNUSED4'] = self.UNUSED4
...
class RM_Register_RAC_CHPCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.UNUSED8 = RM_Field_RAC_CHPCTRL_UNUSED8(self)
        self.zz_fdict['UNUSED8'] = self.UNUSED8
        self.UNUSED7 = RM_Field_RAC_CHPCTRL_UNUSED7(self)
        self.zz_fdict['UNUSED7'] = self.UNUSED7
        self.UNUSED1 = RM_Field_RAC_CHPCTRL_UNUSED1(self)
        self.zz_fdict['UNUSED1'] = self.UNUSED1
        self.UNUSED5 = RM_Field_RAC_CHPCTRL_UNUSED5(self)
        self.zz_fdict['UNUSED5'] = self.UNUSED5
        self.UNUSED6 = RM_Field_RAC_CHPCTRL_UNUSED6(self)
        self.zz_fdict['UNUSED6'] = self.UNUSED6
...
class RM_Register_RAC_LPFCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_RAC_LPFCTRL, self).__init__(rmio, label,
            ...
            u"",
            0x0003C00B, 0x0003FF1F)

        self.LPFBW = RM_Field_RAC_LPFCTRL_LPFBW(self)
        self.zz_fdict['LPFBW'] = self.LPFBW
        self.MIRACLEMODE = RM_Field_RAC_LPFCTRL_MIRACLEMODE(self)
        self.zz_fdict['MIRACLEMODE'] = self.MIRACLEMODE
        self.UNUSED9 = RM_Field_RAC_LPFCTRL_UNUSED9(self)
        self.zz_fdict['UNUSED9'] = self.UNUSED9
        self.UNUSED10 = RM_Field_RAC_LPFCTRL_UNUSED10(self)
        self.zz_fdict['UNUSED10'] = self.UNUSED10
...
class RM_Register_RAC_PAENCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PACTUNEN = RM_Field_RAC_PAENCTRL_PACTUNEN(self)
        self.zz_fdict['PACTUNEN'] = self.PACTUNEN
...
class RM_Register_RAC_PACTUNECTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PACTUNE = RM_Field_RAC_PACTUNECTRL_PACTUNE(self)
        self.zz_fdict['PACTUNE'] = self.PACTUNE
        self.SGPACTUNE = RM_Field_RAC_PACTUNECTRL_SGPACTUNE(self)
        self.zz_fdict['SGPACTUNE'] = self.SGPACTUNE
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_SPARE(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYNTHSPARE = RM_Field_RAC_SPARE_SYNTHSPARE(self)
        self.zz_fdict['SYNTHSPARE'] = self.SYNTHSPARE
        ...
        self.SGLNAMIXSPARE = RM_Field_RAC_SPARE_SGLNAMIXSPARE(self)
        self.zz_fdict['SGLNAMIXSPARE'] = self.SGLNAMIXSPARE
        self.__dict__['zz_frozen'] = True
