...
class RM_Field_RAC_SYNTHREGCTRL_UNUSED3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SYNTHREGCTRL_UNUSED3, self).__init__(register,
            'UNUSED3', 'RAC.SYNTHREGCTRL.UNUSED3', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SYNTHREGCTRL_UNUSED1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SYNTHREGCTRL_UNUSED1, self).__init__(register,
            'UNUSED1', 'RAC.SYNTHREGCTRL.UNUSED1', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_SYNTHREGCTRL_UNUSED2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SYNTHREGCTRL_UNUSED2, self).__init__(register,
            'UNUSED2', 'RAC.SYNTHREGCTRL.UNUSED2', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_VCOCTRL_UNUSED4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_VCOCTRL_UNUSED4, self).__init__(register,
            'UNUSED4', 'RAC.VCOCTRL.UNUSED4', 'read-write',
            u"",
            22, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_CHPCTRL_UNUSED8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_CHPCTRL_UNUSED8, self).__init__(register,
            'UNUSED8', 'RAC.CHPCTRL.UNUSED8', 'read-write',
            u"",
            6, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_CHPCTRL_UNUSED7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_CHPCTRL_UNUSED7, self).__init__(register,
            'UNUSED7', 'RAC.CHPCTRL.UNUSED7', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_CHPCTRL_UNUSED1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_CHPCTRL_UNUSED1, self).__init__(register,
            'UNUSED1', 'RAC.CHPCTRL.UNUSED1', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_CHPCTRL_UNUSED5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_CHPCTRL_UNUSED5, self).__init__(register,
            'UNUSED5', 'RAC.CHPCTRL.UNUSED5', 'read-write',
            u"",
            11, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_CHPCTRL_UNUSED6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_CHPCTRL_UNUSED6, self).__init__(register,
            'UNUSED6', 'RAC.CHPCTRL.UNUSED6', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_LPFCTRL_LPFBW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_LPFCTRL_LPFBW, self).__init__(register,
            'LPFBW', 'RAC.LPFCTRL.LPFBW', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_LPFCTRL_UNUSED9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_LPFCTRL_UNUSED9, self).__init__(register,
            'UNUSED9', 'RAC.LPFCTRL.UNUSED9', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_LPFCTRL_UNUSED10(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_LPFCTRL_UNUSED10, self).__init__(register,
            'UNUSED10', 'RAC.LPFCTRL.UNUSED10', 'read-write',
            u"",
            12, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_RFENCTRL_IFPGAEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_RFENCTRL_IFPGAEN, self).__init__(register,
            'IFPGAEN', 'RAC.RFENCTRL.IFPGAEN', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PAENCTRL_PACTUNEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PAENCTRL_PACTUNEN, self).__init__(register,
            'PACTUNEN', 'RAC.PAENCTRL.PACTUNEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_PACTUNECTRL_PACTUNE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PACTUNECTRL_PACTUNE, self).__init__(register,
            'PACTUNE', 'RAC.PACTUNECTRL.PACTUNE', 'read-write',
            u"",
            0, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_PACTUNECTRL_SGPACTUNE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_PACTUNECTRL_SGPACTUNE, self).__init__(register,
            'SGPACTUNE', 'RAC.PACTUNECTRL.SGPACTUNE', 'read-write',
            u"",
            4, 5)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SPARE_SYNTHSPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SPARE_SYNTHSPARE, self).__init__(register,
            'SYNTHSPARE', 'RAC.SPARE.SYNTHSPARE', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_SPARE_SGLNAMIXSPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_SPARE_SGLNAMIXSPARE, self).__init__(register,
            'SGLNAMIXSPARE', 'RAC.SPARE.SGLNAMIXSPARE', 'read-write',
            u"",
            30, 2)
        self.__dict__['zz_frozen'] = True
