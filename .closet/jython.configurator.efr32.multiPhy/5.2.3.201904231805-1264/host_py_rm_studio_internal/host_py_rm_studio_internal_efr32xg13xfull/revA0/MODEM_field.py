...
class RM_Field_MODEM_DSACTRL_TIMEST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_DSACTRL_TIMEST, self).__init__(register,
            'TIMEST', 'MODEM.DSACTRL.TIMEST', 'read-write',
            u"",
            19, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_DSACTRL_AGCDEBOUNDLY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_DSACTRL_AGCDEBOUNDLY, self).__init__(register,
            'AGCDEBOUNDLY', 'MODEM.DSACTRL.AGCDEBOUNDLY', 'read-write',
            u"",
            20, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_VTCORRCFG0_EXPSYNCLEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_VTCORRCFG0_EXPSYNCLEN, self).__init__(register,
            'EXPSYNCLEN', 'MODEM.VTCORRCFG0.EXPSYNCLEN', 'read-write',
            u"",
            20, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_VTCORRCFG0_BUFFHEAD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_VTCORRCFG0_BUFFHEAD, self).__init__(register,
            'BUFFHEAD', 'MODEM.VTCORRCFG0.BUFFHEAD', 'read-write',
            u"",
            28, 4)
        self.__dict__['zz_frozen'] = True
