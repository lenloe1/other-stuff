...
class RM_Field_AGC_STATUS1_RFPEAKDETRAW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_STATUS1_RFPEAKDETRAW, self).__init__(register,
            'RFPEAKDETRAW', 'AGC.STATUS1.RFPEAKDETRAW', 'read-only',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_STATUS1_RFPEAKDET2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_STATUS1_RFPEAKDET2, self).__init__(register,
            'RFPEAKDET2', 'AGC.STATUS1.RFPEAKDET2', 'read-only',
            u"",
            18, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_STATUS1_RFPEAKDET1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_STATUS1_RFPEAKDET1, self).__init__(register,
            'RFPEAKDET1', 'AGC.STATUS1.RFPEAKDET1', 'read-only',
            u"",
            19, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_RFPEAKDET_RFPKDTHRESH1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_RFPEAKDET_RFPKDTHRESH1, self).__init__(register,
            'RFPKDTHRESH1', 'AGC.RFPEAKDET.RFPKDTHRESH1', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_RFPEAKDET_RFPKDTHRESH2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_RFPEAKDET_RFPKDTHRESH2, self).__init__(register,
            'RFPKDTHRESH2', 'AGC.RFPEAKDET.RFPKDTHRESH2', 'read-write',
            u"",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_RFPEAKDET_RFPKDSWITCHDEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_RFPEAKDET_RFPKDSWITCHDEL, self).__init__(register,
            'RFPKDSWITCHDEL', 'AGC.RFPEAKDET.RFPKDSWITCHDEL', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_IF_SHORTRSSIPOSSTEP(Base_RM_Field):
    def __init__(self, register):
        ...
        super(RM_Field_AGC_IF_SHORTRSSIPOSSTEP, self).__init__(register,
            'SHORTRSSIPOSSTEP', 'AGC.IF.SHORTRSSIPOSSTEP', 'read-only',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_IFS_SHORTRSSIPOSSTEP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_IFS_SHORTRSSIPOSSTEP, self).__init__(register,
            'SHORTRSSIPOSSTEP', 'AGC.IFS.SHORTRSSIPOSSTEP', 'write-only',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_IFC_SHORTRSSIPOSSTEP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_IFC_SHORTRSSIPOSSTEP, self).__init__(register,
            'SHORTRSSIPOSSTEP', 'AGC.IFC.SHORTRSSIPOSSTEP', 'write-only',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_MANUALCTRL_ENMANUALRSTRFPKD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_MANUALCTRL_ENMANUALRSTRFPKD, self).__init__(register,
            'ENMANUALRSTRFPKD', 'AGC.MANUALCTRL.ENMANUALRSTRFPKD', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_MANUALCTRL_MANUALRSTRFPKD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_MANUALCTRL_MANUALRSTRFPKD, self).__init__(register,
            'MANUALRSTRFPKD', 'AGC.MANUALCTRL.MANUALRSTRFPKD', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_MANUALCTRL_ENMANUALRFPKDTHRESH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_MANUALCTRL_ENMANUALRFPKDTHRESH, self).__init__(register,
            'ENMANUALRFPKDTHRESH', 'AGC.MANUALCTRL.ENMANUALRFPKDTHRESH', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_GAINSTEPLIM_SLOWDECAYCNT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_GAINSTEPLIM_SLOWDECAYCNT, self).__init__(register,
            'SLOWDECAYCNT', 'AGC.GAINSTEPLIM.SLOWDECAYCNT', 'read-write',
            u"",
            20, 7)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_GAINSTEPLIM_ADCATTENCODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_GAINSTEPLIM_ADCATTENCODE, self).__init__(register,
            'ADCATTENCODE', 'AGC.GAINSTEPLIM.ADCATTENCODE', 'read-write',
            u"",
            27, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_GAINSTEPLIM_ADCATTENMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_GAINSTEPLIM_ADCATTENMODE, self).__init__(register,
            'ADCATTENMODE', 'AGC.GAINSTEPLIM.ADCATTENMODE', 'read-write',
            u"",
            29, 2)
        self.__dict__['zz_frozen'] = True
