    ...
    def _preprocess_model(self, model):
        ...
        for base_channel_configuration in processed_model.base_channel_configurations.base_channel_configuration:
            ...
            for channel_config_entry in base_channel_configuration.channel_config_entries.channel_config_entry:
                ...
                if (channel_config_entry.radio_configurator_output_model is not None) and not type(channel_config_entry.radio_configurator_output_model) in [str, basestring]:
                ...
                if (channel_config_entry.full_register_model is not None) and not type(channel_config_entry.full_register_model) in [str, basestring]:
