...
class multi_phy_configuration(GeneratedsSuper):
    ...
    name or label of this configuration"""
    member_data_items_ = [
...
class base_channel_configurationType(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('optional_arguments', 'optional_argumentsType8', 0),
    ]
    subclass = None
    superclass = None
    def __init__(self, profile=None, base_channel_reference=None, name=None, force_empty_phy_config_delta_subtract=True, profile_inputs=None, phy=None, channel_config_entries=None, phy_config_base=None, phy_config_delta_subtract=None, link_layer_config=None, optional_arguments=None):
        ...
        if optional_arguments is None:
            self.optional_arguments = optional_argumentsType8()
        else:
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.optional_arguments is not None:
            showIndent(outfile, level)
            outfile.write('optional_arguments=model_.optional_argumentsType8(\n')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'profile_inputs':
            ...
            obj_ = optional_argumentsType8.factory()
            obj_.build(child_)
...
class channel_config_entryType(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('profile_input_overrides', 'profile_input_overridesType1', 0),
    ...
    def __init__(self, name=None, base_frequency=None, channel_spacing=None, physical_channel_offset=None, channel_number_start=None, channel_number_end=None, max_power=None, profile_input_overrides=None, phy_name_override=None, phy_config_delta_add=None, radio_configurator_output_model=None, full_register_model=None, optional_arguments=None):
        ...
        if profile_input_overrides is None:
            self.profile_input_overrides = profile_input_overridesType1()
        else:
            self.profile_input_overrides = profile_input_overrides
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.profile_input_overrides is not None:
            showIndent(outfile, level)
            outfile.write('profile_input_overrides=model_.profile_input_overridesType1(\n')
            self.profile_input_overrides.exportLiteral(outfile, level, name_='profile_input_overrides')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.phy_name_override is not None:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'base_frequency':
            ...
            obj_ = profile_input_overridesType1.factory()
            obj_.build(child_)
            self.profile_input_overrides = obj_
            obj_.original_tagname_ = 'profile_input_overrides'
...
class profile_input_overridesType1(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('override', 'overrideType2', 1),
    ]
    subclass = None
    superclass = None
    def __init__(self, override=None):
        ...
        if override is None:
            ...
            self.override = override
    def factory(*args_, **kwargs_):
        if profile_input_overridesType1.subclass:
            return profile_input_overridesType1.subclass(*args_, **kwargs_)
        else:
            return profile_input_overridesType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_override(self): return self.override
    def set_override(self, override): self.override = override
    def add_override(self, value): self.override.append(value)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='profile_input_overridesType1', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='profile_input_overridesType1')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='profile_input_overridesType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='profile_input_overridesType1'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='profile_input_overridesType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for override_ in self.override:
            override_.export(outfile, level, namespace_, name_='override', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='profile_input_overridesType1'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for override_ in self.override:
            showIndent(outfile, level)
            outfile.write('model_.overrideType2(\n')
            override_.exportLiteral(outfile, level, name_='overrideType2')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class overrideType2(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('key', 'xs:string', 0),
        MemberSpec_('value', 'xs:string', 0),
    ]
    ...
    def __init__(self, key=None, value=None):
        ...
        self.value = value
    def factory(*args_, **kwargs_):
        if overrideType2.subclass:
            return overrideType2.subclass(*args_, **kwargs_)
        else:
            return overrideType2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_key(self): return self.key
    def set_key(self, key): self.key = key
    keyProp = property(get_key, set_key)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='overrideType2', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='overrideType2')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='overrideType2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='overrideType2'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='overrideType2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalue>%s</%svalue>%s' % (namespace_, self.gds_format_string(quote_xml(self.value), input_name='value'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='overrideType2'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class phy_config_baseType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('register', 'registerType3', 1),
    ]
    subclass = None
    superclass = None
    def __init__(self, register=None):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for register_ in self.register:
            showIndent(outfile, level)
            outfile.write('model_.registerType3(\n')
            register_.exportLiteral(outfile, level, name_='registerType3')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class registerType3(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0),
        MemberSpec_('value', 'xs:string', 0),
        MemberSpec_('baseAddress', 'xs:string', 0),
    ...
    def __init__(self, name=None, value=None, baseAddress=None, addressOffset=None, fullname=None, access=None, description=None, resetValue=None, resetMask=None):
        ...
        self.resetMask = resetMask
    def factory(*args_, **kwargs_):
        if registerType3.subclass:
            return registerType3.subclass(*args_, **kwargs_)
        else:
            return registerType3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_name(self): return self.name
    def set_name(self, name): self.name = name
    nameProp = property(get_name, set_name)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='registerType3', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='registerType3')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='registerType3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='registerType3'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='registerType3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.resetMask is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresetMask>%s</%sresetMask>%s' % (namespace_, self.gds_format_string(quote_xml(self.resetMask), input_name='resetMask'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='registerType3'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class phy_config_delta_subtractType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('register', 'registerType4', 1),
    ]
    subclass = None
    superclass = None
    def __init__(self, register=None):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for register_ in self.register:
            showIndent(outfile, level)
            outfile.write('model_.registerType4(\n')
            register_.exportLiteral(outfile, level, name_='registerType4')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class registerType4(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('name', 'xs:string', 0),
        MemberSpec_('value', 'xs:string', 0),
        MemberSpec_('baseAddress', 'xs:string', 0),
    ...
    def __init__(self, name=None, value=None, baseAddress=None, addressOffset=None, fullname=None, access=None, description=None, resetValue=None, resetMask=None):
        ...
        self.resetMask = resetMask
    def factory(*args_, **kwargs_):
        if registerType4.subclass:
            return registerType4.subclass(*args_, **kwargs_)
        else:
            return registerType4(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_name(self): return self.name
    def set_name(self, name): self.name = name
    nameProp = property(get_name, set_name)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='registerType4', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='registerType4')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='registerType4', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='registerType4'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='registerType4', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.resetMask is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sresetMask>%s</%sresetMask>%s' % (namespace_, self.gds_format_string(quote_xml(self.resetMask), input_name='resetMask'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='registerType4'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class link_layer_configType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.phy is not None:
            showIndent(outfile, level)
            outfile.write('phy=model_.phyType6(\n')
            self.phy.exportLiteral(outfile, level, name_='phy')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.link_layer_model is not None:
...
class inputsType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('input', 'inputType5', 1),
    ]
    subclass = None
    superclass = None
    def __init__(self, input=None):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for input_ in self.input:
            showIndent(outfile, level)
            outfile.write('model_.inputType5(\n')
            input_.exportLiteral(outfile, level, name_='inputType5')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class inputType5(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('key', 'xs:string', 0),
        MemberSpec_('value', 'xs:string', 0),
    ]
    ...
    def __init__(self, key=None, value=None):
        ...
        self.value = value
    def factory(*args_, **kwargs_):
        if inputType5.subclass:
            return inputType5.subclass(*args_, **kwargs_)
        else:
            return inputType5(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_key(self): return self.key
    def set_key(self, key): self.key = key
    keyProp = property(get_key, set_key)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='inputType5', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='inputType5')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='inputType5', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='inputType5'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='inputType5', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalue>%s</%svalue>%s' % (namespace_, self.gds_format_string(quote_xml(self.value), input_name='value'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='inputType5'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class phyType6(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if phyType6.subclass:
            return phyType6.subclass(*args_, **kwargs_)
        else:
            return phyType6(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='phyType6', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='phyType6')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='phyType6', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='phyType6'):
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_format_string(quote_attrib(self.name), input_name='name'), ))
    def exportChildren(self, outfile, level, namespace_='', name_='phyType6', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='phyType6'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class overridesType(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('override', 'overrideType7', 1),
    ]
    subclass = None
    superclass = None
    def __init__(self, override=None):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for override_ in self.override:
            showIndent(outfile, level)
            outfile.write('model_.overrideType7(\n')
            override_.exportLiteral(outfile, level, name_='overrideType7')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class overrideType7(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('key', 'xs:string', 0),
        MemberSpec_('value', 'xs:string', 0),
    ]
    ...
    def __init__(self, key=None, value=None):
        ...
        self.value = value
    def factory(*args_, **kwargs_):
        if overrideType7.subclass:
            return overrideType7.subclass(*args_, **kwargs_)
        else:
            return overrideType7(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_key(self): return self.key
    def set_key(self, key): self.key = key
    keyProp = property(get_key, set_key)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='overrideType7', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='overrideType7')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='overrideType7', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='overrideType7'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='overrideType7', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalue>%s</%svalue>%s' % (namespace_, self.gds_format_string(quote_xml(self.value), input_name='value'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='overrideType7'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class optional_argumentsType8(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('argument', 'argumentType9', 1),
    ]
    subclass = None
    superclass = None
    def __init__(self, argument=None):
        ...
        if argument is None:
            ...
            self.argument = argument
    def factory(*args_, **kwargs_):
        if optional_argumentsType8.subclass:
            return optional_argumentsType8.subclass(*args_, **kwargs_)
        else:
            return optional_argumentsType8(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_argument(self): return self.argument
    def set_argument(self, argument): self.argument = argument
    def add_argument(self, value): self.argument.append(value)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='optional_argumentsType8', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='optional_argumentsType8')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='optional_argumentsType8', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='optional_argumentsType8'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='optional_argumentsType8', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for argument_ in self.argument:
            argument_.export(outfile, level, namespace_, name_='argument', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='optional_argumentsType8'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for argument_ in self.argument:
            showIndent(outfile, level)
            outfile.write('model_.argumentType9(\n')
            argument_.exportLiteral(outfile, level, name_='argumentType9')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class argumentType9(GeneratedsSuper):
    member_data_items_ = [
        MemberSpec_('key', 'xs:string', 0),
        MemberSpec_('value', 'xs:string', 0),
    ]
    ...
    def __init__(self, key=None, value=None):
        ...
        self.value = value
    def factory(*args_, **kwargs_):
        if argumentType9.subclass:
            return argumentType9.subclass(*args_, **kwargs_)
        else:
            return argumentType9(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_key(self): return self.key
    def set_key(self, key): self.key = key
    keyProp = property(get_key, set_key)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='argumentType9', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='argumentType9')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='argumentType9', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='argumentType9'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='argumentType9', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.value is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalue>%s</%svalue>%s' % (namespace_, self.gds_format_string(quote_xml(self.value), input_name='value'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='argumentType9'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
GDSClassesMapping = {
    ...
    'phy': phyType6,
    'profile_input_overrides': profile_input_overridesType1,
    'inputs': inputsType,
    'file': fileType,
    'override': overrideType7,
    'input': inputType5,
