...
def build_modem_regs_jumbo(model,profile, family):
    ...
    profile.outputs.append(ModelOutput(model.vars.RAC_PACTUNECTRL_SGPACTUNETX, '',            ModelOutputType.SVD_REG_FIELD, readable_name='RAC.PACTUNECTRL.SGPACTUNETX'              ))
    profile.outputs.append(ModelOutput(model.vars.RAC_PACTUNECTRL_SGPACTUNERX, '',            ModelOutputType.SVD_REG_FIELD, readable_name='RAC.PACTUNECTRL.SGPACTUNERX'              ))
