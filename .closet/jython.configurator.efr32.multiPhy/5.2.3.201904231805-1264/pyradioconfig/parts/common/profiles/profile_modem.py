...
def buildModemAdvancedInputs(model, profile, family):
    ...
    IProfile.make_linked_io(profile, model.vars.freq_offset_hz                    , 'Advanced', readable_name="AFC Frequency Limit",                          value_limit_min=0,      value_limit_max=500000, units_multiplier=UnitsMultiplier.KILO)
    ...
    IProfile.make_linked_io(profile, model.vars.bandwidth_hz                      , 'Advanced', readable_name="Channel Bandwidth",                            value_limit_min=100,    value_limit_max=bandwidth_limit_adc, units_multiplier=UnitsMultiplier.KILO)
    ...
    IProfile.make_linked_io(profile, model.vars.sqi_threshold                     , 'Advanced', readable_name="Signal Quality Indicator Threshold",           value_limit_min=0,      value_limit_max=255)
    ...
    IProfile.make_linked_io(profile, model.vars.afc_period                        , 'Advanced', readable_name="AFC Offset Period",                            value_limit_min=0,      value_limit_max=7)
    ...
    IProfile.make_linked_io(profile, model.vars.afc_step_scale                    , 'Advanced', readable_name="AFC Step Scale",                               value_limit_min=0.0,    value_limit_max=2.0, fractional_digits=2)
    ...
    IProfile.make_linked_io(profile, model.vars.rx_bitrate_offset_hz              , 'Advanced', readable_name="RX Baudrate offset",                           value_limit_min=0,      value_limit_max=200000)
    ...
    IProfile.make_linked_io(profile, model.vars.ook_slicer_level                  , 'Advanced', readable_name="OOK slicer level",                               value_limit_min=1,     value_limit_max=10)
