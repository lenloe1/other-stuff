...
def build_modem_regs_panther_lynx_common_part1(model, profile, family):
    ...
    profile.outputs.append(ModelOutput(model.vars.FRC_DATABUFFER_DATABUFFER, '', ModelOutputType.SVD_REG_FIELD,        readable_name='FRC.DATABUFFER.DATABUFFER'))
...
def build_modem_regs_lynx_only(model, profile, family):
    ...
    profile.outputs.append(ModelOutput(model.vars.MODEM_ANTSWCTRL_ANTSWRST, '',         ModelOutputType.SVD_REG_FIELD, readable_name='MODEM.ANTSWCTRL.ANTSWRST'           ))
    ...
    profile.outputs.append(ModelOutput(model.vars.RAC_LNAMIXTRIM0_LNAMIXRFPKDCALCM, '',         ModelOutputType.SVD_REG_FIELD, readable_name='RAC.LNAMIXTRIM0.LNAMIXRFPKDCALCM'           ))
    ...
    profile.outputs.append(ModelOutput(model.vars.RAC_LNAMIXTRIM1_LNAMIXIBIASADJ, '',         ModelOutputType.SVD_REG_FIELD, readable_name='RAC.LNAMIXTRIM1.LNAMIXIBIASADJ'           ))
