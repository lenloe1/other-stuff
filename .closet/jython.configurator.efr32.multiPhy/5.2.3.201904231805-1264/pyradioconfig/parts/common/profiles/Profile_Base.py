...
class Profile_Base(IProfile):
    ...
    def buildProfileModel(self, model):
        ...
        if family.lower() in ["panther", "lynx", "ocelot"]:
            ...
            IProfile.make_optional_input(profile, model.vars.src1_range_available_minimum, "modem", default=125, readable_name="SRC range minimum",      value_limit_min=125,         value_limit_max=155)
        ...
        # No, this breaks RAIL
        if family in ["dumbo", "jumbo", "nerio", "nixi", "panther", "lynx"]:
