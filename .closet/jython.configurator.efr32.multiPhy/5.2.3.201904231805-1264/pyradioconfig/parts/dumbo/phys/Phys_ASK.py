...
class PHYS_ASK(IPhy):
    ...
    def PHY_Enocean_868MHz_org(self, model):
        ...
        phy.profile_outputs.MODEM_SYNC0_SYNC0.override = long(9)
        ...
        phy.profile_outputs.SYNTH_FREQ_FREQ.override = long(32836266)
    ...
    def PHY_Enocean_868MHz(self, model):
        ...
        phy.profile_inputs.syncword_0.value =  long(9)
