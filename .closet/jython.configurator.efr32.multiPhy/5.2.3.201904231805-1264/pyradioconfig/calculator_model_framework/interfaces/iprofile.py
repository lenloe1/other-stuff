...
class IProfile(object):
    ...
    """
    def deprecated_moveVariableFromForcesIntoInputs(self, profile, varForce, category, default=None, input_name=None,
        ...
        # Add to inputs
        profile.inputs.append(ModelInput(varForce, category, default, input_name, None, value_limit_min, value_limit_max, fractional_digits=fractional_digits ))
        pass
