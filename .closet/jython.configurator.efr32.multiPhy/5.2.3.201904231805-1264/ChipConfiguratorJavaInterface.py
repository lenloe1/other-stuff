...
from com.silabs.java.utils import TextUtils
...
#         profileId = TextUtils.print(configInput.get(ChipConfiguratorData.RADIO_PROFILE))
...
#             self.configurator.instance(chipId).set_profile(profileId)
        ...
        if profileId is None:
            ...
            configurator.set_profile(TextUtils.print(profileId))
        else:
            ...
            for item in configInput.keys():
                if item != ChipConfiguratorData.RADIO_PROFILE:
                    profileData[item] = TextUtils.print(configInput.get(item))
            configurator.add_profile(TextUtils.print(profileId), profileData)
